...
public class UIManager : MonoBehaviour
{
    ...
    {
        weaponCost.text = string.Format("{0:#,0}", (CharStateManager.Instance.weaponSkillLv + 1) * 5);
    ...
    {
        stageText.text = $"현재 : {GameManager.instance.curStage + 1}\n최고 : {GameManager.instance.highstStage + 1}";
    }
    public void ShowStoreText()
    {
         addsGoldText.text = "광고\r\n<sprite=0>" + string.Format("{0:#,0}", 100 * (GameManager.instance.highstStage+1)); 
         purchaseGoldText.text = "Gold구매\r\n<sprite=0>" + string.Format("{0:#,0}", 1000 * (GameManager.instance.highstStage+1)); 
    }
}
